...
func WriteDeck(writer io.Writer, deck *Deck) error {
...
func ReadDeck(reader io.Reader) (*Deck, error) {
	var deck Deck
...
// ValidateCards verifies that every main-deck entry resolves in the repository.
